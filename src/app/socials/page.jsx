...
const Socials = () => {
  ...
  return (
    <div className="parentContainer flex w-full h-screen mx-auto justify-center">
      <div
        className="siblingsContainer flex flex-col h-[85%] justify-center sm:h-full sm:max-w-[35rem] lg:max-w-[60rem] mx-auto space-y-[1rem]"
      >
          ...
          >
              ...
              <div className="flex flex-col space-y-[0.6rem]">
                <div className="flex flex-row space-x-2 text-md group relative">
                  ...
                  <span
                    ...
                    className="cursor-pointer lg:hover:text-blue-400 transition-colors duration-200 flex items-center"
                  >
                    khattarraajveer@gmail.com
                    <span className="ml-2 opacity-0 lg:group-hover:opacity-100 transition-opacity duration-200">
                      {copiedEmail ? (
                    ...
                    {showEmailTooltip && !copiedEmail && (
                      <div className="hidden lg:block absolute -top-8 left-1/2 transform -translate-x-1/2 px-2 py-1 bg-gray-800 text-white text-sm rounded shadow-lg whitespace-nowrap">
                        Click to copy!
                        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 rotate-45 w-2 h-2 bg-gray-800"></div>
                      </div>
                    )}
                    {copiedEmail && (
                      <div className="hidden lg:block absolute -top-8 left-1/2 transform -translate-x-1/2 px-2 py-1 bg-green-600 text-white text-sm rounded shadow-lg whitespace-nowrap">
                        Copied!
            ...
            >
              ...
              <div className="flex flex-row space-x-[1.5rem]">
                <a
                  className="lg:hover:scale-110 transition duration-200"
