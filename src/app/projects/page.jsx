...
const Projects = () => {
  ...
  return (
    <div className="parentContainer w-full m-0 p-0 overflow-hidden flex h-screen">
      <div className="interContainer max-w-[60rem] flex flex-col space-y-[2rem] mx-auto justify-center">
        ...
        <div className="siblingsContainer w-full flex flex-col justify-start space-y-[2rem] cursor-default">
          <div
            className="text-2xl font-bold text-start text-white underline"
          ...
          <div className="workContainer flex flex-col space-y-0 items-start align-middle">
            <div className="flex flex-row w-full space-x-[1rem]">
              ...
              >
                ...
                >
                  <div className="flex flex-row space-x-[1rem] items-start" style={getAnimationStyle(0.3)}>
                    <div className="flex flex-col items-start space-y-[0rem]">
                      <div className="workTitle text-[1.1rem] font-semibold text-white">
                    ...
                    <div
                      className="self-start px-[0.6rem] py-[0.35rem] flex items-center text-[0.6rem] border-white border-2 rounded-full transition animate-pulse"
                      style={{ animationDuration: "4s" }}
                    >
                      currently building
                    </div>
                  </div>
                  <div className="workDescription text-sm text-white mt-[0.7rem]" style={getAnimationStyle(0.35)}>
            ...
            <div className="flex flex-row w-full space-x-[1rem]">
              ...
              <div
                className="workItem flex flex-col mt-[-1rem]"
