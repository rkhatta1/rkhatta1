...
const About = () => {
  ...
  return (
    <div className="parentContainer flex flex-col w-full h-screen mx-auto justify-center">
      <div
        className="siblingsContainer flex flex-col items-center sm:max-w-[28rem] lg:max-w-[35rem] mx-auto space-y-[1rem]"
      ...
      >
        ...
        <div style={getAnimationStyle(0.1)}>
          ...
          <div className="transition grayscale hover:grayscale-0 duration-[1.2s]">
            <Image
              ...
              width={1920}
              height={1080}
              className="rounded-none sm:h-[14rem] sm:w-[28rem] lg:h-[15rem] lg:w-[35rem] object-cover"
        ...
        >
          ...
          <div
            className="aboutPara text-start p-0 m-0 space-y-[0.7rem] lg:text-md sm:text-sm"
